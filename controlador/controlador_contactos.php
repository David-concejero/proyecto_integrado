...
<head>
  ...
  <!-- CSS y JS -->
  <link rel="stylesheet" type="text/css" href="../vista/css/controlador_contactos.css">
...
<!-- Contenido Contactos -->
  <div class="col-md-12 fondo_contactos">
      <h1 class="section-title"><span class="text">Contacto</span></h1>
  </div>
  <div class="col-md-12">
    <div class="row">
      <div class="col-md-6">
        <img src="../vista/imagenes/varios/imagenContacto.jpg" class="img-fluid">
      </div>
      <div class="col-md-6 informacion_contacto">
        <h3> Atención CineEspaña: Cartelera & Taquillas  </h3>
          <ul>
            <li>
              <span class="fa fa-phone icono_normal"></span> 954 516 558  
            </li>
            <li> 
              <span class="fa fa-envelope icono_normal"></span>  cineespaña@gmail.com
            </li>
            <li> Horario de atención. De 17:30 a 23:00. </li>
          </ul>
        <h3> Atención CineEspaña: Zona Este  </h3>
          <ul>
            <li>
              <span class="fa fa-phone icono_normal"></span> 954 999 850
            </li>
            <li> 
              <span class="fa fa-envelope icono_normal"></span>  info@cinespaña.com
            </li>
            <li> Horario de atención: De 9:00 a 22:00 </li>
          </ul>
              ...
              <div class="row">
                <div class="col-4">
                  <a href="https://www.twitter.com">
                    <span class="fa fa-twitter icono_redesSociales"></span> 
                  </a>
                </div>
                <div class="col-4">
                  <a href="https://www.facebook.com">
                    <span class="fa fa-facebook icono_redesSociales"></span> 
                  </a>
                </div>
                <div class="col-4">
                  <a href="https://www.google.com">
                    <span class="fa fa-google icono_redesSociales"></span> 
                  </a>
                </div>
              </div>
            </li>
